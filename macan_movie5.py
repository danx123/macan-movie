...
class VideoPlayerWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        # FIX: Hapus animasi fade yang berpotensi menyebabkan masalah render
        # Widget akan ditampilkan/disembunyikan secara langsung
...
# (Sisa kode dari VideoThumbnailWidget hingga akhir tidak diubah, tetap sama seperti aslinya)
...
if __name__ == "__main__":
    ...
    main_window.show() # Tampilkan jendela utama secara normal, bukan fullscreen
    sys.exit(app.exec())