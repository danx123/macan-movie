...
from PyQt6.QtWidgets import (
    ...
    QDialog, QListWidget, QListWidgetItem, QDialogButtonBox, QMenu, QGraphicsOpacityEffect
)
...
class ClickableSlider(QSlider):
    ...
    def mousePressEvent(self, event: QMouseEvent):
        if event.button() == Qt.MouseButton.LeftButton:
            # FIX: Pastikan pembagian tidak menghasilkan nol untuk menghindari error
            if self.width() > 0:
                value = self.minimum() + (self.maximum() - self.minimum()) * event.pos().x() / self.width()
                self.setValue(int(value))
                # Emit sinyal sliderMoved agar pemutar video merespons
                self.sliderMoved.emit(int(value))
        # Panggil implementasi dasar untuk fungsionalitas normal (seperti menggeser)
...
class VideoPlayerWindow(QMainWindow):
    def __init__(self, video_path: str, parent=None):
        ...
        # Latar belakang jendela hitam untuk pengalaman menonton yang lebih baik
        ...
        self.toggle_play()
        # Tampilkan kontrol saat pertama kali dibuka
        self.show_controls()
    ...
    def _setup_ui(self):
        ...
        # Jadikan jendela ini sebagai parent agar bisa tampil di atas video
        ...
        # FIX: Gunakan QGraphicsOpacityEffect untuk animasi fade yang andal
        ...
        self.controls_animation = QPropertyAnimation(self.opacity_effect, b"opacity")
        ...
        self.stop_button = QPushButton() # FIX: Tambah tombol stop
        ...
        for btn in [self.play_pause_button, self.stop_button, self.volume_button, self.fullscreen_button]:
            btn.setFlat(True)
    ...
    def _setup_player(self):
        ...
        self.stop_icon = IconManager.get_icon("stop") # FIX: Tambah ikon stop
    ...
    def _connect_signals(self):
        ...
        self.stop_button.clicked.connect(self.stop_video) # FIX: Hubungkan tombol stop
    ...
    def stop_video(self):
        ...
        self.close() # Menutup jendela pemutar video
    ...
    def hide_controls(self):
        # Hanya sembunyikan jika sedang fullscreen dan video diputar
    ...
    def show_controls(self):
        ...
        # Reset timer setiap kali kontrol ditampilkan
    ...
    # FIX: Implementasikan event klik kanan untuk menampilkan kontrol
...
if __name__ == "__main__":
    ...
    # FIX: Tampilkan jendela utama dalam mode fullscreen
