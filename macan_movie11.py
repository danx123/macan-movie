...
class VideoPlayerWindow(QMainWindow):
    def __init__(self, playlist: list, current_index: int, parent=None):
        ...
        # FIX 1: Logika timer untuk menyembunyikan kontrol dihapus agar kontrol selalu tampil.
        ...
        # FIX 2: Pemutaran video dipindahkan ke `showEvent` untuk mengatasi layar hitam.
        # self.toggle_play()
    ...
    def _setup_ui(self):
        ...
        self.controls_overlay = QWidget(self.container)
        self.controls_overlay.setMouseTracking(True)
        
        self.controls_widget = QWidget(self.controls_overlay)
        ...
        # FIX 1: Hapus panggilan untuk menyembunyikan kontrol. Kontrol akan tampil secara default.
    ...
    def toggle_play(self):
        ...
        # FIX 1: Panggilan ke `show_controls` dihapus karena kontrol selalu tampil.
        # self.show_controls()
    ...
    # FIX 1: Metode `hide_controls`, `show_controls`, dan `mouseMoveEvent` dihapus
    # karena kontrol tidak lagi disembunyikan secara otomatis.
    ...
    # FIX 2: Menambahkan metode showEvent untuk memulai video saat jendela ditampilkan.
    def showEvent(self, event):
        """Memulai pemutaran video saat jendela pertama kali ditampilkan."""
        super().showEvent(event)
        # Mulai video hanya jika belum diputar.
        # Menggunakan QTimer.singleShot untuk memastikan jendela sudah
        # sepenuhnya digambar sebelum playback dimulai, ini memperbaiki bug layar hitam.
