...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # PERBAIKAN: setGeometry memastikan jendela tidak fullscreen saat pertama kali dijalankan
...
if __name__ == "__main__":
    ...
    # DIHAPUS: Menghapus setStyle("Fusion") sesuai permintaan untuk mengatasi bug bilah navigasi.
    # app.setStyle("Fusion") 
    
    # Palet gelap tetap dipertahankan untuk tema aplikasi.
    ...
    # PERBAIKAN: Menggunakan .show() akan menampilkan jendela dalam ukuran normal
    # yang telah diatur oleh setGeometry atau state yang tersimpan.
    main_window.show()
    sys.exit(app.exec())