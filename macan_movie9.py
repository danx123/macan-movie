...
from PyQt6.QtWidgets import (
    ...
    QDialog, QListWidget, QDialogButtonBox, QMenu
)
from PyQt6.QtMultimedia import QMediaPlayer, QAudioOutput
from PyQt6.QtMultimediaWidgets import QVideoWidget
from PyQt6.QtCore import Qt, QUrl, QSettings, QTimer, QSize, QPoint, QFileInfo, QPointF
from PyQt6.QtGui import QPixmap, QImage, QIcon, QMouseEvent, QKeyEvent, QAction, QPainter, QPalette, QColor, QFontDatabase
...
class IconManager:
    ...
    def get_icon(name: str, color: str = "#ecf0f1", size: QSize = QSize(24, 24)) -> QIcon:
        """Membuat QIcon dari data SVG dengan warna dan ukuran yang ditentukan."""
...
class VideoPlayerWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        self.controls_overlay = QWidget(self.centralWidget())
...
class VideoThumbnailWidget(QFrame):
    def __init__(self, video_path: str, all_videos: list, main_window, parent=None):
        ...
        self.title_label.setStyleSheet("color: #ecf0f1; border: none;")
...
class MainWindow(QMainWindow):
    ...
    def show_message(self, message):
        ...
        self.grid_layout.addWidget(msg_label, 0, 0, 1, -1)
